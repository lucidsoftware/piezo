...
ALTER TABLE QRTZ_CALENDARS
  MODIFY COLUMN `CALENDAR_NAME`  VARCHAR(100) NOT NULL;
...
ALTER TABLE QRTZ_FIRED_TRIGGERS
  MODIFY COLUMN `TRIGGER_NAME` VARCHAR(100) NOT NULL,
  MODIFY COLUMN `TRIGGER_GROUP` VARCHAR(100) NOT NULL,
  MODIFY COLUMN `JOB_NAME` VARCHAR(100) NULL,
  MODIFY COLUMN `JOB_GROUP` VARCHAR(100) NULL;

ALTER TABLE QRTZ_SCHEDULER_STATE
  MODIFY COLUMN `INSTANCE_NAME` VARCHAR(100) NOT NULL;
